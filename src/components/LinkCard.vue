...
<template>
  <a
    ...
    class="group relative flex w-full items-center gap-4 rounded-xl border border-indigo-700 bg-indigo-950 p-4 shadow-md shadow-indigo-900/40 transition-all duration-300 hover:scale-[1.02] hover:border-cyan-400 hover:shadow-xl hover:shadow-cyan-500/30"
  >
    <!-- Icon Container -->
    <div
      class="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-indigo-900 text-cyan-400 transition-all duration-300 group-hover:scale-110 group-hover:bg-cyan-500 group-hover:text-indigo-950 group-hover:shadow-xl group-hover:shadow-cyan-500/40"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="truncate text-sm text-indigo-300">
        {{ description }}
      </p>
    </div>
